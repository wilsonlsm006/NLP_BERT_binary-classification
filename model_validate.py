...
输出：预测的数据 np数组
"""
def model_evaluate(model_load_path, test_data_path, test_predict_data):
     # 获取测试数据集
    ...
    # 模型预测
    test_value_df = model_load_predict(model_load_path, test_df, test_predict_data)
...
if __name__ == '__main__':
    ...
    # 模型评估
    model_evaluate(MODEL_LOAD_PATH, TEST_DATA_PATH, TEST_PREDICT_DATA)
